...
from routes import cart_router, genre_router, movie_router, order_router, payment_router
...
app.include_router(genre_router, prefix=f"{api_version_prefix}/cinema", tags=["genres"])
